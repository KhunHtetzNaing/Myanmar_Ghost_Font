...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.maa.mmghostfont", "com.maa.mmghostfont.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.maa.mmghostfont", "com.maa.mmghostfont.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.maa.mmghostfont.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
int _height = 0;
 ...
 //BA.debugLineNum = 32;BA.debugLine="mm = mm.LoadFromAssets(\"Ghost.ttf\")";
...
_copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 172;BA.debugLine="copy.setText(\"#MyanmarGhostFont App! This is Beau";
_copy.setText(mostCurrent.activityBA,"#MyanmarGhostFont App! This is Beautiful Myanmar Zawgyi Font Style! You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.myanmarandroidapp.com/search?q=Myanmar+Ghost+Font");
