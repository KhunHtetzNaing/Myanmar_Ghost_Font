...
public class other extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.maa.mmghostfont", "com.maa.mmghostfont.other");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.maa.mmghostfont", "com.maa.mmghostfont.other");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.maa.mmghostfont.other", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 122;BA.debugLine="File.Copy(File.DirAssets,\"Ghost.ttf\",File.DirRoo";
...
mostCurrent._lb = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Ghos";
