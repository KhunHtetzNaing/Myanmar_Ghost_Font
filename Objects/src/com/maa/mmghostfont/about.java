...
public class about extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.maa.mmghostfont", "com.maa.mmghostfont.about");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.maa.mmghostfont", "com.maa.mmghostfont.about");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.maa.mmghostfont.about", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
_lblname.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 41;BA.debugLine="lblName.Text = \"Myanmar Ghost Font\"";
_lblname.setText(BA.ObjectToCharSequence("Myanmar Ghost Font"));
...
mostCurrent._lstone.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 56;BA.debugLine="lstOne.AddSingleLine2(\"App Name : Myanmar Ghost F";
mostCurrent._lstone.AddSingleLine2(BA.ObjectToCharSequence("App Name : Myanmar Ghost Font"),(Object)(1));
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._p.OpenBrowser("http://www.myanmarandroidapp.com/search?q=Myanmar+Ghost+Font")));
