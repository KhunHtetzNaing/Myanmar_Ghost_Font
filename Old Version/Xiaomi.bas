...
Sub b1_Click
	...
	'	If File.Exists(File.DirRootExternal & "/MIUI/theme","Ghost.mtz") = True Then File.Delete(File.DirRootExternal,"MIUI/theme/Ghost.mtz")
	'	File.Copy(File.DirAssets,"Ghost.mtz",File.DirRootExternal & "/MIUI/theme","Ghost.mtz")
