package com.htetznaing.mmghostfont;
...
public class vivo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmghostfont", "com.htetznaing.mmghostfont.vivo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmghostfont", "com.htetznaing.mmghostfont.vivo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmghostfont.vivo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.htetznaing.mmghostfont.slidemenu _sm = null;
...
public com.htetznaing.mmghostfont.main _main = null;
public com.htetznaing.mmghostfont.main2 _main2 = null;
public com.htetznaing.mmghostfont.samsung _samsung = null;
public com.htetznaing.mmghostfont.oppo _oppo = null;
public com.htetznaing.mmghostfont.huawei _huawei = null;
public com.htetznaing.mmghostfont.tutorial _tutorial = null;
public com.htetznaing.mmghostfont.about _about = null;
public com.htetznaing.mmghostfont.xiaomi _xiaomi = null;
public com.htetznaing.mmghostfont.other _other = null;
...
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 30;BA.debugLine="lb.Text = \"	Install ကိုႏွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Ch";
mostCurrent._lb.setText((Object)("	Install ကိုႏွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Change Font1 ကိုနွိပ္ပါ Ghost.txj ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ မရခဲ့ရင္ Change Font2 ကိုနွိပ္ျပီး Myanmar Ghost Font နာမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font ကိုႏွိပ္ၿပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"));
...
mostCurrent._tlb.setText((Object)("Vivo"));
 //BA.debugLineNum = 79;BA.debugLine="tlb.Color = Colors.rgb(156, 39, 176)";
mostCurrent._tlb.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (156),(int) (39),(int) (176)));
...
mostCurrent._banner.Initialize2(mostCurrent.activityBA,"Banner","ca-app-pub-4173348573252986/5474946951",mostCurrent._banner.SIZE_SMART_BANNER);
...
mostCurrent._interstitial.Initialize(mostCurrent.activityBA,"Interstitial","ca-app-pub-4173348573252986/6951680150");
...
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Vivo Myanmar Font/Ghost.txj");};
 //BA.debugLineNum = 136;BA.debugLine="File.Copy(File.DirAssets,\"Ghost.txj\",File.DirRoot";
...
mostCurrent._msg.setText((Object)("File Manager တစ္ခုခုထဲသို႔သြားၿပီး Vivo Myanmar Font ဖိုဒါထဲကိုဝင္ပါ။ Ghost.txj ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ သို႔မဟုတ္ Change Font2 နဲ႔ထပ္သြင္းၾကည့္ပါ။"));
...
mostCurrent._msg.setText((Object)("Install ကိုႏွိပ္ၿပီးတာနဲ႔ ဖုန္းမွာ Default File Manager တစ္ခုခုမေရြးထားရင္ေတာ့ ကိုယ့္ဘာသာကို ဖုန္းထဲက File Manager တစ္ခုခုထဲကိုသြားလိုက္ပါ။	ၿပီးရင္ Vivo Myanmar Font ဆိုတဲ့ဖိုဒါကိုရွာၿပီး ဝင္လိုက္ပါ။ အဲ့ဖိုဒါထဲမွာ Ghost.txj ဆိုတဲ့ဖိုင္ေလးကိုဖြင့္ၿပီး Apply ေပးလိုက္ပါ။ အဆင္မေျပတာမ်ားရွိရင္ Facebook က Myanmar Android Apps မွာလာေမးနိုင္ပါတယ္ :)"));
...
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Download/i Theme/Font/Ghost.txj");};
 //BA.debugLineNum = 162;BA.debugLine="File.Copy(File.DirAssets,\"Ghost.txj\",File.DirRoot";
...
mostCurrent._sm = new com.htetznaing.mmghostfont.slidemenu();
...
mostCurrent._lb = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Ghos";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 250;BA.debugLine="copy.setText(\"#Myanmar_Ghost_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Ghost_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+Ghost+Font");
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 228;BA.debugLine="copy.setText(\"#Myanmar_Ghost_Font App! Beautifu";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Ghost_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+Ghost+Font");
