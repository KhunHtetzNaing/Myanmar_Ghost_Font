...
public class about extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmghostfont", "com.htetznaing.mmghostfont.about");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmghostfont", "com.htetznaing.mmghostfont.about");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmghostfont.about", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
_lblname.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 46;BA.debugLine="lblName.Text = \"Myanmar Ghost Font\"";
_lblname.setText((Object)("Myanmar Ghost Font"));
...
mostCurrent._lstone.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 61;BA.debugLine="lstOne.AddSingleLine2(\"App Name : Myanmar Ghost F";
mostCurrent._lstone.AddSingleLine2("App Name : Myanmar Ghost Font",(Object)(1));
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 80;BA.debugLine="tlb.Text = \"Myanmar Ghost Font\"";
mostCurrent._tlb.setText((Object)("Myanmar Ghost Font"));
 //BA.debugLineNum = 81;BA.debugLine="tlb.Color = Colors.rgb(156, 39, 176)";
