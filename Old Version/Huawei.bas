...
Sub Activity_Create(FirstTime As Boolean)
	...
	lb.Text = "Install ကိုႏွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး Myanmar Ghost Font နာမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font ကိုႏွိပ္ၿပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"
...
Sub b1_Click
	...
	If File.Exists(File.DirRootExternal & "/HWThemes","Ghost.hwt") = True Then File.Delete(File.DirRootExternal,"Ghost.hwt")
	File.Copy(File.DirAssets,"Ghost.hwt",File.DirRootExternal & "/HWThemes","Ghost.hwt")
